...
<textarea name="description" placeholder="description..." class="py-20 bg-transparent  block bolder-b-2 w-full  h-20 text-xl outline-none">{{ $post->description}}</textarea>
